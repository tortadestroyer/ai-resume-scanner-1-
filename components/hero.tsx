      ...
      <div className="relative mx-auto max-w-7xl text-center">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex items-center rounded-full bg-gradient-to-r from-blue-100 to-purple-100 px-6 py-3 text-sm font-medium text-blue-700 shadow-lg hover-lift magnetic-hover"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="mb-4 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl lg:text-5xl"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="mb-6 text-lg text-gray-600 md:text-xl max-w-3xl mx-auto leading-relaxed"
          >

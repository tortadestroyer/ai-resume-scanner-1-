...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="px-4 py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-float -z-10"></div>
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-float -z-10" style={{ animationDelay: '3s' }}></div>
      ...
      <div className="mx-auto max-w-7xl relative">
        ...
        >
          ...
          <motion.div
            className="mb-12 inline-flex items-center rounded-xl bg-white/95 p-1 shadow-lg border border-gray-200"
          ...
          {plans.map((plan, index) => (
            ...
            >
              <Card className={`relative h-full transition-all duration-500 overflow-hidden ${
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-purple-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg -z-10"
                  initial={false}
                />
              </Card>
            </motion.div>
